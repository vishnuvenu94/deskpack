...
import { needsLibsqlRuntimeProbe } from "../build/windows-runtime.js";
...
export function generateElectronMain(config: DeskpackConfig): string {
  ...
  const shouldProbeLibsqlRuntime = needsLibsqlRuntimeProbe(config);
...
const SHOULD_PROBE_LIBSQL_RUNTIME = ${JSON.stringify(shouldProbeLibsqlRuntime)};
...
app.whenReady().then(async () => {
  ...
  try {
    ...
    assertWindowsNativeRuntimePrerequisites();
